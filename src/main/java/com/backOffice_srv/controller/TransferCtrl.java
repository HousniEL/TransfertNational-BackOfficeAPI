...
public class TransferCtrl {
    ...
    public ResponseEntity<?> getTransfers(@RequestParam("page") Integer page){
    ...
    @GetMapping("/Multitransfers")
    public ResponseEntity<?> getTransferById(@RequestParam("page") Integer page){
        return (agentService.getTransferByAll(page));
    }
