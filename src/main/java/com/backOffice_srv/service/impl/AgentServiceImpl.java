...
public class AgentServiceImpl implements AgentService {
    ...
    public ResponseEntity<?> getClients() {
        restTemplate.setErrorHandler(new RestTemplateResponseErrorHandler());
        return restTemplate.getForEntity(client_rest_url+"/clients", Object.class,1);
    }

    @Override
    public ResponseEntity<?> countClients() {
        restTemplate.setErrorHandler(new RestTemplateResponseErrorHandler());
        return restTemplate.getForEntity(client_rest_url+"/clients/count", Object.class,1);
    }

    @Override
    public ResponseEntity<?> getTransferByAll(Integer page) {
        restTemplate.setErrorHandler(new RestTemplateResponseErrorHandler());
        return restTemplate.getForEntity(transfer_rest_url+"/MultiTransfers?page="+page, Object.class,1);
